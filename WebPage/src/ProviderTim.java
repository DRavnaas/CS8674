package org.hunter.medicare.tim;  // ToDo - change this once we know our package name
...
public class ProviderTim {  
  ...
  public ProviderTim(String id)
  {
    this.id = id; 
  }
  
   // Constructor used by SolrJ
   public ProviderTim(Map<String, Object> fields)
   {
